define(function() {
  ...
  return {
    ...
    onInit(){
      ...
      this.view.flxDarkModeOption.onClick = () => {
        this.toggle(false, true);
        this.onItemSelected('darkMode');
      };
      this.view.segMenu2.onRowClick = () => {
        this.toggle(false, true);
        this.onItemSelected(this.view.segMenu2.selectedRowItems[0].key);
      };
